...
class UNet(nn.Module):
    def __init__(self, n_class):
        ...
        self.base_model.fc = nn.Linear(num_ftrs,self.n_class)
        # #----
        self.base_model.load_state_dict(torch.load("/home/klose/CanineMammaryTumors/segmentation/best_models_final/CATCH_segmentation_model_modified.pth"), strict = False)
